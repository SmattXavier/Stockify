...
const Userdropdown = () => {
    ...
    const user = {name: "Abraham", email: "smattabraham123@gmail.com", password: "123browserproject"};
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent className='text-gray-400'>
                ...
                <DropdownMenuSeparator className= 'hidden sm:block '></DropdownMenuSeparator>
